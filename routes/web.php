...
Route::middleware('checkDownvotes')->group(function () {
    Route::middleware('blockIp')->group(function () {
        ...
        Route::get('/allNews', [HomeController::class, 'viewNews'])->name('news');
        ...
        Route::get('/threadList', [ThreadController::class, 'viewHotThread'])->name('thread.list');
        //Thread Vote Routes
        ...
        Route::middleware('moderator')->group(function () {
            ...
            Route::delete('/mod/thread/{id}/ban', [ModeratorController::class, 'banThread'])->name('mod-thread.ban');
            ...
            Route::delete('/mod/comment/{id}/ban', [ModeratorController::class, 'banComment'])->name('mod-comment.ban');
        });
    });
});
